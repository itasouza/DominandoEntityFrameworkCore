...
using System;
using TreinamentoModeloDeDados.Domain;

namespace TreinamentoModeloDeDados.Data
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            const string strConnection = "Server=DESKTOP-N8415MR\\SQLEXPRESS;Database=DominandoEFCoreDados;User Id=sa;Password=root;pooling=true;";
            optionsBuilder
        ...
        {
            //usando o Collations (CI) não diferencia maiúsculo de minusculo ou acentuação
            modelBuilder.UseCollation("SQL_Latin1_General_CP1_CI_AI");
            //exemplo - RAFAEL -> rafael
            //exemplo - Jõao -> Joao
            //habilitando apenas para um campo
